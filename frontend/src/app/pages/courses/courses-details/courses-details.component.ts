...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, ReactiveFormsModule, FormsModule, DragDropModule, EditorModule],
...
export class CoursesDetailsComponent implements OnInit {
  ...
  tinyMceConfig = {
    ...
    plugins: [
      ...
      // Premium features (free trial until Mar 8, 2026)
  ...
  getAcceptedFileTypes(): string {
    ...
    switch (lessonType) {
      ...
      case LessonType.IMAGE: return 'image/*';
      case LessonType.FILE: return '.pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx';
      default: return '*';
    }
  }
  ...
  getMediaIcon(type: LessonType): string {
    switch (type) {
      ...
      case LessonType.IMAGE: return 'bi-image';
      case LessonType.FILE: return 'bi-file-earmark';
      case LessonType.TEXT: return 'bi-file-text';
      case LessonType.MIXED: return 'bi-collection';
