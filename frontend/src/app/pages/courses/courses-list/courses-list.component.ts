...
export class CoursesListComponent implements OnInit {
  ...
  getLevelColor(level: EnglishLevel): string {
    const colors = {
      [EnglishLevel.BEGINNER]: 'bg-green-100',
      [EnglishLevel.ELEMENTARY]: 'bg-blue-100',
      [EnglishLevel.INTERMEDIATE]: 'bg-yellow-100',
      [EnglishLevel.UPPER_INTERMEDIATE]: 'bg-orange-100',
      [EnglishLevel.ADVANCED]: 'bg-purple-100'
    };
