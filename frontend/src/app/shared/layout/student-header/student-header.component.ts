...
@Component({
  ...
  template: `
    <header
      class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b shadow-sm">
      <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
          ...
          <!-- Logo -->
          <a routerLink="/" class="xl:hidden flex items-center gap-2">
            <img class="h-14" src="/images/logo/jungle-in-english-removebg-preview.png" alt="Jungle in English" />
          </a>
          ...
          <div class="hidden xl:block">
            <form>
              <div class="relative">
                ...
                <input #searchInput type="text" placeholder="Search or type command..."
                  class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-primary-500 focus:outline-hidden focus:ring-3 focus:ring-primary-500/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-primary-700 xl:w-[430px]" />
                <button
